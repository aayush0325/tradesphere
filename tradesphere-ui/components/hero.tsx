                    ...
                    <div className="space-y-8">
                        <div className="space-y-4">
                            ...
                            <p className="text-xl text-muted-foreground max-w-2xl">
                                Experience real-world trading without the risk.
                                TradeSphere offers advanced backtesting,
                                algorithmic trading, and collaborative learning
                        ...
                        <div className="relative z-10 bg-card border rounded-2xl p-6 shadow-2xl">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="h-20 bg-muted rounded-lg p-2">
                                    <TradingChart
                                        data={[
                                            24.5, 24.2, 24.8, 24.1, 24.9, 25.2,
                                            24.7, 25.5, 25.1, 25.8, 25.3, 26.1,
                                        ]}
                                        height={64}
                                        showGrid={false}
                                        showLegend={false}
