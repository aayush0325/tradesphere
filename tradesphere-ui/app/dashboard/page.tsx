  ...
  useEffect(() => {
    const syncUser = async () => {
      ...
      try {
        ...
        const response = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL || 'http://localhost:8000'}/api/v1/users/sync`, {
          method: 'POST',
          headers: {
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg p-6 text-white">
              ...
              <p className="text-blue-100">Start with $10,000 virtual cash and build your portfolio</p>
            </div>
            
            <div className="bg-gradient-to-r from-green-500 to-green-600 rounded-lg p-6 text-white">
              <h3 className="text-xl font-semibold mb-2">Live Market Data</h3>
              <p className="text-green-100">Access real-time stock prices and market information</p>
            </div>
            
            <div className="bg-gradient-to-r from-purple-500 to-purple-600 rounded-lg p-6 text-white">
              <h3 className="text-xl font-semibold mb-2">Trading Strategies</h3>
              <p className="text-purple-100">Test and refine your trading strategies safely</p>
            </div>
          </div>
